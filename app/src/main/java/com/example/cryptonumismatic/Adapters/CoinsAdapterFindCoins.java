...
public class CoinsAdapterFindCoins extends RecyclerView.Adapter<CoinsAdapterFindCoins.ViewHolder> {
    private List list;
    private Context context;
    private ClickAddElementListener clickAddElementListener;

    public CoinsAdapterFindCoins(List list, Context context, ClickAddElementListener clickAddElementListener) {
        this.list = list;
    ...
    @NonNull
    @Override
    public CoinsAdapterFindCoins.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list,parent,false);
        return new CoinsAdapterFindCoins.ViewHolder(view,clickAddElementListener);
    }

    @Override
    public void onBindViewHolder(@NonNull CoinsAdapterFindCoins.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            clickAddElementListener.onClickAddElementFindCoins(getAdapterPosition());
        }
    }
    public interface ClickAddElementListener{
        void onClickAddElementFindCoins(int position);
    }
}